...
export default function Home() {
  ...
  const contractAddress = "0xbF40364341470645a9BB693fCb8d1f25F1ECF19f";
  ...
  return (
    <div className="min-h-screen relative pb-20">
      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-0 md:px-4 pt-4 md:pt-10 pb-10 md:pb-20 overflow-hidden">
        ...
        <div className="mt-1">
           <a 
              href={`https://www.ponsfamily.com/launchpad/0xbF40364341470645a9BB693fCb8d1f25F1ECF19f`}
              target="_blank"
        ...
        <div className="lg:col-span-8">
          <RetroWindow title="notepad.exe - LORE.TXT" className="h-full min-h-[300px]">
            <div className="font-mono text-sm md:text-base space-y-4">
               ...
               <br/>
               <p>This is not a financial asset. This is a külture artifact preserved on the Robinhood blockchain. We are here to bring in the dancing lobsters.</p>
